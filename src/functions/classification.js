...
const inputDummy = "hapus pertanyaan apakah itb susah? dan hapus pertanyaan rava ganteng ngga? dan tambah pertanyaan jovan imut ga? dengan jawaban kaga dan tambah pertanyaan rava kece ga? dengan jawaban iya dan hitung 50 *2 dan 40*2 dan tentukan tanggal 20/02/2023 dan 20/03/2023 dan apakah itb gampang?";
...
function classification(question){
    ...
    const eraseQueryRegex = /(?<=hapus pertanyaan).*?(?= dan|$)/ig;
